...
import { Search, ThumbsUp, Github, ExternalLink } from "lucide-react";
      ...
      <main className="flex-1">
        <div className="container py-10">
          <div className="mb-8">
            ...
            <p className="text-sm text-muted-foreground">Projects built with Claude AI by the community</p>
          </div>
          ...
          <>
            <p className="mb-4 text-xs text-muted-foreground">{projects?.length ?? 0} projects</p>
