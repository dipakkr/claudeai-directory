      ...
      <>
        ...
        {resolution.verified ? (
          <button
            ...
            className="inline-flex h-9 cursor-pointer items-center rounded-lg bg-primary px-3.5 text-[13.5px] font-medium text-white transition-colors hover:bg-[var(--cad-accent-hover)] dark:hover:bg-primary/90"
          >
            {CTA_LABEL[kind]}
          </button>
        ) : (
